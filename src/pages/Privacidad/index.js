...
export default class Privacidad extends Component {
  ...
  render() {
    return (
        <div>
          {this.state.isLogged ? <Navbar/> : <HeaderPreLogin />}
          
          <div className="container__privacidad ">
            <div className="wrap__inner mt-5">
            <h1>TÉRMINOS DE SERVICIO</h1>
            <h2>INFORMACIÓN GENERAL</h2>

            <p>Este sitio web es operado por Xihuala App. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Xihuala App. Xihuala App ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
            ...
            <h2>SECCIÓN 3 - EXACTITUD, EXHAUSTVIDAD Y ACTUALIDAD DE LA INFORMACIÓN</h2>
            ...
            <h2>SECTION 4 - MODIFICACIONES AL SERVICIO Y PRECIOS</h2>
            ...
            <h2>SECCIÓN 5 - PRODUCTOS O SERVICIOS (si aplicable)</h2>
            ...
            <h2>SECCIÓN 18 - LEY</h2>
            <p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Horacio 400, Colonia  Polanco, Miguel Hidalgo, DIF, 11560, Mexico.</p>
            ...
            <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a xihualaapp@gmail.com.</p>
